...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| We have points on boundary and therefore there is no need for special boundary treatment.                                                                                                                             | This approach means the control volumes are expensive to store and the flux integral expensive to compute, as the control volume is constructed from many smaller edges or faces |
...
| For both structured and unstructured meshes it allows higher order flux integration. One value of flux is assumed across each control volume face; more faces equals more values of flux, or higher spatial accuracy. |                                                                                                                                                                                  |
