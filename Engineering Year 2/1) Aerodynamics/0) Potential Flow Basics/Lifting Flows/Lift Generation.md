...
We've already calculated our $C_{p}$ [[Engineering Year 2/1) Aerodynamics/0) Potential Flow Basics/Lifting Flows/Lifting Cylinder Flow#Calculating the Velocities and the Pressure Coefficient|here]] so:
