Vector fields are harder to visualise. One needs to represent vectors at each point in space. One way to do this is by using arrows with varying length or thickness.
