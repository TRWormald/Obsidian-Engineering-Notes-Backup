There are many methods available for finding the solution of PDEs. We need to tailor our method to the type of PDE, the domain, and possibly even the boundary conditions.
There are:
