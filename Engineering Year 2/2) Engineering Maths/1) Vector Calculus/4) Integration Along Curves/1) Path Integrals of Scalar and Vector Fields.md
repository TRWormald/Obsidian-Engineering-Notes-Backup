...
In order to evaluate such path integrals we need to have a parametrisation of the curve $C(t)$ just like we did in [[1) Path Integrals of Scalar and Vector Fields#Example 4.1|Example 4.1]]. So:
